...
int main() {
    ...
    // Create a SimpleVector of chars.
    SimpleVector<char> charTables(SIZE);

    // Store values in the two SimpleVectors.
    for (count = 0; count < SIZE; count++) {
        intTable[count] = count * 2;
        doubleTable[count] = count * 2.14;
        charTables[count] = 'A' + count;
    }
    ...
    for (count = 0; count < SIZE; count++)
        cout << charTables[count] << " ";
    cout << endl;

    // Use the standard + operator on the elements.
    cout << "\nAdding 5 to each element of intTabl, doubleTable, and charTable.\n";
    for (count = 0; count < SIZE; count++) {
        intTable[count] = intTable[count] + 5;
        doubleTable[count] = doubleTable[count] + 5.0;
        charTables[count] = charTables[count] + 5;
    }
    ...
    // Use the standard ++ operator on the elements.
    cout << "\nIncrementing each element of intTable and doubleTable, and charTable.\n";
    for (count = 0; count < SIZE; count++) {
        intTable[count]++;
        doubleTable[count]++;
        charTables[count]++;
