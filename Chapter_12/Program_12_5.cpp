...
// Accepts a reference to a fstream object as an argument.
// The file is opened for input. The function returns true
...
// Accepts a fstream reference as its argument. Uses a loop
// to read each name from the file and displays it on the
// screen.
//**********************************************************
