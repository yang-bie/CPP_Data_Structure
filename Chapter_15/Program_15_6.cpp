...
int main() {
    ...
    cout << "We have the following car in inventory:\n" << car.getModel() << " "
        << car.getMake() << " with " << car.getDoors() << " doors and "
        << car.getMileage() << " miles\nPrice: $" << car.getPrice() << endl << endl;

    cout << "We have the following truck in inventory:\n" << truck.getModel() << " "
      << truck.getMake() << " with " << truck.getDriveType() << " drive type and "
      << truck.getMileage() << " miles\nPrice: $" << truck.getPrice() << endl << endl;

    cout << "We have the following suv in inventory:\n" << suv.getModel() << " "
      << suv.getMake() << " with " << suv.getPassengers() << " passenger capacity and "
